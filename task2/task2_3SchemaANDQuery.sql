...
SELECT
	...
	cl.hp AS "HP",
	p.first_name AS "Teacher's first name",
	ci.study_period AS "Period",
   	
	SUM(CASE WHEN ta.activity_name = 'Lecture' AND a.person_id = p.id AND pa.course_instance_id  = a.course_instance_id AND pa.activity_id = a.activity_id
		THEN a.allocation_hours * ta.factor ELSE 0 END )
    		AS "Lecture Hours",
	SUM(CASE WHEN ta.activity_name = 'Tutorial' THEN a.allocation_hours * ta.factor ELSE 0 END )
    		AS "Tutorial Hours",
	SUM(CASE WHEN ta.activity_name = 'Lab' THEN a.allocation_hours * ta.factor ELSE 0 END )
    		AS "Lab Hours",
	SUM(CASE WHEN ta.activity_name = 'Seminar' THEN a.allocation_hours * ta.factor ELSE 0 END )
    		AS "Seminar Hours",
	SUM(CASE WHEN ta.activity_name = 'Other' THEN a.allocation_hours * ta.factor ELSE 0 END )
    		AS "Other Overhead Hours",
	SUM(CASE WHEN ta.activity_name = 'Admin' THEN (2 * cl.hp + 0.2 * ci.num_students + 28) ELSE 0 END)
		 AS  "Admin",
	SUM(CASE WHEN ta.activity_name = 'Exam' THEN 32 + (0.725 * ci.num_students) ELSE 0 END)
		AS "Exam",
	(	
		SUM(CASE WHEN ta.activity_name = 'Lecture'  THEN a.allocation_hours * ta.factor ELSE 0 END ) + 
		SUM(CASE WHEN ta.activity_name = 'Tutorial'  THEN a.allocation_hours * ta.factor ELSE 0 END )+ 
		SUM(CASE WHEN ta.activity_name = 'Lab'  THEN a.allocation_hours * ta.factor ELSE 0 END )+ 
		SUM(CASE WHEN ta.activity_name = 'Seminar'  THEN a.allocation_hours * ta.factor ELSE 0 END )+ 
		SUM(CASE WHEN ta.activity_name = 'Other'  THEN a.allocation_hours * ta.factor ELSE 0 END ) +
...
WHERE ci.id = a.course_instance_id 
  ...
  AND pa.course_instance_id  = a.course_instance_id
